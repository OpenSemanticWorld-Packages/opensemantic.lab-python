...
Welcome to `opensemantic.lab` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.lab`, please have a look
...
You can help improve `opensemantic.lab` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.lab` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.lab`'s files. While this mechanism can
...
```
conda create -n opensemantic.lab python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.lab
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.lab.git
   cd opensemantic.lab
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.lab` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.lab
[issue tracker]: https://github.com/<USERNAME>/opensemantic.lab/issues
